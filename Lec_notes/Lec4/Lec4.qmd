...
+ The more advanced R functions such as `feols()` function from `fixest` package and `glm()` function for generalized linear models will be covered in the Econometric class (APEC 8211-8214).
